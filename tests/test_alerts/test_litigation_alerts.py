...
class TestClickTracking:
    """Kept here because the broken branded click host is one of the three regressions this file
    exists for — the wire-level assertion for each provider lives in test_email_transport."""

    def test_disabled_by_default(self):
        """The rewrite sends every link through the provider's click host. On SendGrid that host
        ...
        assert settings.email_click_tracking is False
